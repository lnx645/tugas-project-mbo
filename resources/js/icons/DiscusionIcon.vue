<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
        <g fill="currentColor">
            <path d="M18.5 26c0 2.21-1.79 4-4 4s-4-1.79-4-4s1.79-4 4-4s4 1.79 4 4" />
            <path
                fill-rule="evenodd"
            ...
            <path
                ...
                clip-rule="evenodd"
            />
            <path d="M37.5 26c0 2.21-1.79 4-4 4s-4-1.79-4-4s1.79-4 4-4s4 1.79 4 4" />
            <path
                fill-rule="evenodd"
                d="M33.5 28a1.999 1.999 0 1 0 0-4a1.999 1.999 0 1 0 0 4m0 2c2.21 0 4-1.79 4-4s-1.79-4-4-4s-4 1.79-4 4s1.79 4 4 4"
                clip-rule="evenodd"
            />
            <path d="M28 24c0 2.21-1.79 4-4 4s-4-1.79-4-4s1.79-4 4-4s4 1.79 4 4" />
            <path
                fill-rule="evenodd"
            ...
            />
            <path
                d="M23 12.833A4.833 4.833 0 0 0 18.167 8h-3.169a4.998 4.998 0 0 0-.181 9.993L15 18v2s8-1.167 8-7.167m3-1.597A5.236 5.236 0 0 1 31.236 6H37a5 5 0 0 1 0 10h-2v3s-9-1.264-9-7.764m-1 25.31C25 33.522 30.663 32 33.5 32s8.5 1.523 8.5 4.545V42H25z"
            />
            <path
                fill-rule="evenodd"
